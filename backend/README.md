...
- Otomatik kapanış testi: `python manage.py test api.tests.test_faz1_kapanis_e2e -v 2` (tercihen `USE_SQLITE=1`) — rapor: [`documentation/FAZ1-KAPANIS-TEST-SONUCU.md`](../documentation/FAZ1-KAPANIS-TEST-SONUCU.md)
