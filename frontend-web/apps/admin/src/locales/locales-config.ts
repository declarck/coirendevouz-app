...
// MUI Core Locales
import { trTR as trTRCore, enUS as enUSCore } from '@mui/material/locale';
// MUI Date Pickers Locales
import { trTR as trTRDate, enUS as enUSDate } from '@mui/x-date-pickers/locales';
// MUI Data Grid Locales
import { trTR as trTRDataGrid, enUS as enUSDataGrid } from '@mui/x-data-grid/locales';

// ----------------------------------------------------------------------

// Supported languages (Coirendevouz panel: Turkish + English)
export const supportedLngs = ['tr', 'en'] as const;
export type LangCode = (typeof supportedLngs)[number];

// Fallback and default namespace
export const fallbackLng: LangCode = 'tr';
