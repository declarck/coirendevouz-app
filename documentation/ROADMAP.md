...
| # | Çıktı | Not |
|---|--------|-----|
| 1.1 | Django projesi, PostgreSQL, temel ayarlar | Ortamlar: dev / staging ayrımı hedeflenir. |
| 1.2 | Kullanıcı modeli ve roller (müşteri, işletme yöneticisi, istenirse personel) | Django uyumlu auth. |
